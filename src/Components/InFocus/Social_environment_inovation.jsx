...
import { Social_environment_inovation } from './InFocusDetails'

const Social_environment = () => {
  return (
    <section className="body-font">
            <div className="w-full mx-auto mb-12 flex justify-center flex-wrap">
                {Social_environment_inovation.map((item, index) => (
                    <>
                    
                    <div key={index} className="flex flex-col lg:flex-row mb-3  justify-between px-4 mt-10"  data-aos="fade-up"  data-aos-delay="300">
                        <div className="mb-10 lg:w-[70%] flex flex-col gap-4 md:gap-0 md:flex-row h-fit w-full items-start py-5 ">
...
export default Social_environment
