...
const Content = () => {
  return (
    <>
      ...
      <section class="content body-font overflow-hidden relative z-20 h-fit -top-40 md:-top-28 lg:top-[-5rem] neon-blue-bg mt-20" 
     >
         <div class="w-full px-5 pb-14 mx-auto"
         data-aos="fade-up"  data-aos-duration="800" data-aos-delay="500" data-aos-easing="ease-in-out">
