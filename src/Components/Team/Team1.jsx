...
const Team1 = ({index, name, post, title, description, img_url,read_more , FbUrl, LinkedIn }) => {
   ...
   <>
        ...
        <div className="p-4 md:w-1/2 lg:w-1/2  sm:mb-0 mb-6 my-10 ">
          <div className="photos lg:h-1/2 md:h-2/5 md:w-1/2  mt-4 mx-auto rounded-lg  overflow-hidden">
            <img alt="content" className="object-cover object-center  my-auto w-full mx-auto h-full md:transform md:scale-90   border-[6px] border-gray-100 shadow-sm rounded-lg " src={img_url} />
          </div>
