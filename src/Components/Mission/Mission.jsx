...
const Mission = () => {
    return (
        <>
            <div id="mission" className="px-4 py-8 lg:px-16 lg:py-12 bg-gray-50 text-justify">
                <div className="w-full   mx-auto  md:flex-row flex-col justify-between items-start">
                    ...
                    data-aos="fade-up"  data-aos-easing="ease-in-out">
                        ...
                        <h1 className="text-3xl font-bold lg:text-5xl mb-6  text-indigo-900">Our Mission</h1>
                         <div className=' flex justify-center items-center lg:mb-10'>
                            <hr className=' w-1/4 bg-cyan-800 h-[3px]' />
                            <span><i class="ri-arrow-down-s-line text-4xl text-amber-700"></i></span>
                            <hr className=' w-1/4 bg-indigo-800 h-[3px]' />
                        </div>
                        <h3 id="para1" className="text-[1rem]  leading-relaxed mb-6 text-gray-700">
                    ...
                    <div class=" xl:w-3/4 p-5 lg:px-8 py-10 my-10 mb-16 bg-gray-200 border-b-4 border-gray-500  mx-auto"
                    data-aos="fade-up" data-aos-easing="ease-in-out">
                        ...
                        <div className="flex flex-wrap justify-center" >
                            {Data.map((item, index) => (
                                ...
                                data-aos = {`${item.css}`}>
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-r from-indigo-200 to-indigo-400 transform scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-500"></div>


                                    <div className="flip-card transform lg:scale-100 relative z-10 p-5 py-0 flex flex-col items-start border-l-[3px] border-amber-600">
