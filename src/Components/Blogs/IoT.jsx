        ...
        <section className="body-font -mt-8">
            <div className="w-full mx-auto mb-12 flex justify-center flex-wrap">
                {Iot.map((item, index) => (
                   ...
                   data-aos="fade-up">
                        <div className="md:mb-10 lg:w-[70%] flex flex-col md:flex-row h-fit w-full items-start py-5 ">
                            <div className="flex w-fit flex-shrink-0 flex-col text-center leading-none px-5 py-3 mb-3 md:mb-0 border-2 bg-indigo-950 hover:bg-indigo-900 rounded-lg">
