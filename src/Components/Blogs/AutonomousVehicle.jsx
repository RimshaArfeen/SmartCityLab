...
import { Vehicle } from './BlogDetails'

const AutonomousVehicle = () => {
  return (
    <section className="body-font lg:-mt-10" >
            <div className="w-full mx-auto mb-12 flex justify-center flex-wrap">
                {Vehicle.map((item, index) => (
                     <>
                    
                     <div key={index} className="flex flex-col lg:flex-row  justify-between px-4 mt-10"  data-aos="fade-up" >
                        <div className="mb-10 flex-col md:flex-row lg:w-[70%] flex h-fit w-full items-start py-5 pb-0 ">
                            <div className="flex w-fit flex-shrink-0 flex-col text-center leading-none px-5 py-3 mb-3 border-2 bg-indigo-950 hover:bg-indigo-900 rounded-lg">
                    ...
                    <hr className=' h-[3px] bg-amber-600 w-5/6' data-aos="zoom-in" data-aos-duration="1500" />
                    </>
                ))}
