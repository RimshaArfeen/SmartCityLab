...
const Nav2 = () => {
  return (
    <div className='w-full text-gray-200 bg-[#24242465] relative z-30 top-24'>
      <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center py-4 uppercase text-base lg:w-5/6 justify-around">
        <NavLink to="/" className="mr-5 transition-all duration-300 hover:cursor-pointer hover:text-gray-900 hover:underline underline-offset-4">our technology</NavLink>
