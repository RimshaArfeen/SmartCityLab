...
const Publications = () => {
  ...
  return (
    <section className="text-gray-600 body-font relative">
      <div className="w-fullpx-0 md:px-5 py-24 mx-auto flex flex-col md:flex-row  justify-around items-start relative top-36">
        {/* Articles */}
            ...
            <div key={index} className="p-2 w-1/3 md:w-full">
              ...
              >
                ...
                <div className="flex-grow leading-relaxed">
                  ...
                  <p className="text-blue-800 text-xs">Learn More</p>
                </div>
              </div>
            </div>
          ))}
                  ...
                  {pubDetails
                    ...
                    .map((pubDetail, index) => (
                      <>
                        ...
                        <div key={index} class="w-full mx-auto mb-14 md:mb-0 md:mt-6">
                          ...
                          <div class="flex flex-col lg:flex-row mt-10">
                            <div class="w-full lg:w-[70%] lg:pr-2 sm:py-8 lg:border-r border-indigo-700 sm:border-t-0  mb-4 pb-4 sm:mb-0 text-left">
                              ...
                              <hr className='w-[13%] block bg-indigo-600 h-[4px] rounded-full mb-2  ' />
                         ...
                         `}
                              ...
                              <a href={`${pubDetail.readMore}`} class="text-indigo-500 inline-flex items-center hover:cursor-pointer">Learn More
                            ...
                            <div class=" w-full lg:w-[30%] text-center lg:pl-8 sm:py-8">
                              <div class="flex  flex-wrap -m-4">
                                <div class="p-4  w-full md:w-2/5 lg:w-full">
                                  ...
                                  <hr className='w-1/5 bg-indigo-600 h-[4px] rounded-full mb-2  ' />
                        ...
                        <hr className=' w-full md:w-3/4 bg-indigo-600 h-[2px] rounded-full mx-auto my-14'
                          data-aos="zoom-in" />
                      </>
                    ))}
